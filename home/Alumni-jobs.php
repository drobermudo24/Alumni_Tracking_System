...
<body>
	<header>
		<div class="container-fluid" style="background-color: #1b274f;">
            ...
            <li class="nav-item">
              <a class="nav-link active" href="Alumni-jobs.php">Jobs</a>
            </li>
            <li class="nav-item">
...
<!-- starting php code -->
      ...
      <div class="modal-body">
        ...
        <form action="Alumni-jobs.php" method="POST" enctype="multipart/form-data">
         	<input type="hidden" name="jid" id="jid">
                    ...
                    <div class="form-group">
                        <textarea cols="30" rows="5" class="form-control textarea" name="message" placeholder="Compose your message.." readonly="">Good day! This is an application for job posted on alumni tracking system. Application from: <?php echo $_SESSION['email'];?> </textarea>
                    </div>
                     <div class="form-group">
